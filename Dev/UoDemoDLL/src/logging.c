...
void (*FUNC_DebugPrint)(char* format, ...) = NULL;	// This is the prototype for the core function hooked by PI_DebugWriteInfo.
...
void Initialize_logging()
{
	...
	FUNC_DebugPrint=(void*)ptFUNC_DebugPrint; // initialize FUNC_DebugPrint with the proper address in core.
}
